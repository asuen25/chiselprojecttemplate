...
```sh
git clone git@github.com:asuen25/chiselprojecttemplate.git
cd chiselprojecttemplate
```
...
#### Commit your changes
```sh
git commit -m 'Starting chiselprojecttemplate'
...
```sh
mill chiselprojecttemplate.test
```
